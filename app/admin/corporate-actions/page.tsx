...
type CorporateActionType = 'Dividend' | 'AGM' | 'Rights Issue' | 'Stock Split' | 'Announcement'
const TYPES: CorporateActionType[] = ['Dividend', 'AGM', 'Rights Issue', 'Stock Split', 'Announcement']
                        ...
                        {TYPES.map(t => (
                            <button
                                ...
                                className={`cursor-pointer rounded-full border-none px-3 py-1 text-[12px] font-medium transition-colors ${
                                    type === t ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-600'
                                }`}
                            >
                                {t}
                            </button>
